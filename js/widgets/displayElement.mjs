import { mediaFactory } from "../modules/mediaFactory.mjs";

export function displayElement(data, startIndex, endIndex) {
     const sectionContainer = document.querySelector("#sous-section2-1-2");
     let elementDiv = "";
     data.reverse()
          .slice(startIndex, endIndex)
          .forEach((info) => {
               elementDiv += `<div class="sous-section2-1-2-child1">
    <div class="sous-section2-1-2-child1-header-title">
        ...
        <div class="sous-section2-1-2-child1-header-title-span">
            ...
            <span  class="sous-section2-1-2-child1-header-title-span3">Thursday,jun 31, ${
                 info.idPost
            }:50 PM</span>
        </div>
    </div>
...
<div class="sous-section2-1-2-child5">
    ...
    <img src="./assets/icons/music.svg" alt="" class=" music-icons">
     ...
     elementDiv += "<div id='limiteObservation'></div>";

     sectionContainer.insertAdjacentHTML("afterend", elementDiv);
}
